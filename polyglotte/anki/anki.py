...
Usage :
  python anki.py extract <fichier|dossier> [--model gpt-…] [--worker n]
  python anki.py lexicon <fichier|dossier> [--model gpt-…] [--worker n]
  python anki.py merge   <fichier.json|dossier/> [-o deck.apkg] [-n "Nom"] [--card DE-FR|FR-DE]
"""
